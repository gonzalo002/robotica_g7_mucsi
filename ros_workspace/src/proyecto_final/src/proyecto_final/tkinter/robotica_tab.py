...
class RoboticaTab:
    def __init__(self, root:ttk.Window, tab:ttk.Frame, tab_active:bool) -> None:
        self.root = root
        self.tab = tab
    ...
    def start_robot_tab(self):
        ...
        self.frame_rob.grid(row=0, column=0, sticky="nsew")

        width = self.tab.winfo_width()*0.6
    ...
    def _rviz_frame(self):
        ...
        try:
            ...
            self.root.after(1500, self.reparent_rviz, self.win_info)
