...
class RLActionGoal {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = RLGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static getMessageSize(object) {
    ...
    length += RLGoal.getMessageSize(object.goal);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new RLActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = RLGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new RLGoal()
    }
