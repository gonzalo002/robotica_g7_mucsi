...
class RLActionFeedback {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = RLFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new RLActionFeedback(null);
    ...
    data.feedback = RLFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new RLActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = RLFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new RLFeedback()
    }
...
module.exports = RLActionFeedback;
