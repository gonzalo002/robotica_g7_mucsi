...
"""autogenerated by genpy from proyecto_final/RLActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class RLActionFeedback(genpy.Message):
  _md5sum = "f6b9982adf40387b623f73697ab6c3c4"
  _type = "proyecto_final/RLActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','proyecto_final/RLFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(RLActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = proyecto_final.msg.RLFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = proyecto_final.msg.RLFeedback()
